...
def build_rpg_ai_knowledge():
    ...
    lines = [
        ...
        "SKILL PROGRESSION: skills unlock at levels "+", ".join(map(str, SKILL_UNLOCK_LEVELS))+"; mastery is rank 1-5; each mastery rank adds "+(SKILL_RANK_DAMAGE*100).toFixed(1)+"% skill damage and "+(SKILL_RANK_HEAL*100).toFixed(1)+"% healing scaling.",
